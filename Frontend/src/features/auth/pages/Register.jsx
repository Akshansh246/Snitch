...
const Register = () => {
    ...
    async function handleSubmit(e) {
        ...
        toast('Registeration Sucessfully Completed')
        navigate('/home')
    }
    ...
    return (
        <main className='w-screen h-screen text-white flex items-center justify-center'>
            ...
            <div className='flex h-fit rounded-lg overflow-hidden'>
                <img className='h-165 hidden object-cover lg:block' src="https://images.unsplash.com/photo-1710023141893-5ccbe1c4ae6d?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                <div className='w-full md:w-120 bg-snitch-bg/30 backdrop-blur-lg px-12 py-8 flex flex-col gap-6 items-center justify-center text-snitch-text'>
